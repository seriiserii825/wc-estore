                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <ul class="multi-column-dropdown">
                                        <h6>Mobiles</h6>
                                        <li>
                                            <a href="products.html">Mobile Phones</a>
                                        </li>
                                        <li>
                                            <a href="products.html">Mp3 Players
                                                <span>New</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="products.html">Popular Models</a>
                                        </li>
                                        <li>
                                            <a href="products.html">All Tablets
                                                <span>New</span>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <div class="col-sm-3">
                                    <ul class="multi-column-dropdown">
                                        <h6>Accessories</h6>
                                        <li>
                                            <a href="products1.html">Laptop</a>
                                        </li>
                                        <li>
                                            <a href="products1.html">Desktop</a>
                                        </li>
                                        <li>
                                            <a href="products1.html">Wearables
                                                <span>New</span>
                                            </a>
                                        </li>
                                        <li>
                                ...
                                <div class="col-sm-2">
                                    <ul class="multi-column-dropdown">
                                        <h6>Home</h6>
                                        <li>
                                            <a href="products2.html">Tv</a>
                                        </li>
                                        <li>
                                            <a href="products2.html">Camera</a>
                                        </li>
                                        <li>
                                            <a href="products2.html">AC</a>
                                        </li>
                                        <li>
                                            <a href="products2.html">Grinders</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-sm-4">
                                    <div class="w3ls_products_pos">
                                        ...
                                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/1.jpg" alt=" " class="img-responsive"/>
                                    </div>
                                </div>
        ...
        <div class="col-md-7 wthree_banner_bottom_right">
            <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                <ul id="myTab" class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation">
                        <a href="#kitchen" role="tab" id="kitchen-tab" data-toggle="tab"
                           aria-controls="kitchen">Kitchen
                        </a>
                    </li>
                </ul>
                <div id="myTabContent" class="tab-content">
                        ...
                        <div class="agile_ecommerce_tabs">
                            <div class="col-md-4 agile_ecommerce_tab_left">
                                <div class="hs-wrapper">
                                    ...
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/4.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/5.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/6.jpg" alt=" " class="img-responsive"/>
                                ...
                                <h5>
                                    <a href="single.html">Mobile Phone1</a>
                                </h5>
                                <div class="simpleCart_shelfItem">
                                    <p>
                                        <span>$380</span>
                                        <i class="item_price">$350</i>
                                    </p>
                                    <form action="#" method="post">
                                        <input type="hidden" name="cmd" value="_cart"/>
                            ...
                            <div class="col-md-4 agile_ecommerce_tab_left">
                                ...
                                <h5>
                                    <a href="single.html">Mobile Phone2</a>
                                </h5>
                                <div class="simpleCart_shelfItem">
                                    <p>
                                        <span>$330</span>
                                        <i class="item_price">$302</i>
                                    </p>
                                    <form action="#" method="post">
                                        <input type="hidden" name="cmd" value="_cart"/>
                                        <input type="hidden" name="add" value="1"/>
                            ...
                            <div class="col-md-4 agile_ecommerce_tab_left">
                                ...
                                <h5>
                                    <a href="single.html">Mobile Phone3</a>
                                </h5>
                                <div class="simpleCart_shelfItem">
                                    <p>
                                        <span>$250</span>
                                        <i class="item_price">$245</i>
                                    </p>
                                    <form action="#" method="post">
                                        <input type="hidden" name="cmd" value="_cart"/>
                                        <input type="hidden" name="add" value="1"/>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="audio" aria-labelledby="audio-tab">
                        <div class="agile_ecommerce_tabs">
                            <div class="col-md-4 agile_ecommerce_tab_left">
                                <div class="hs-wrapper">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/8.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/9.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/10.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/8.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/9.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/10.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/8.jpg" alt=" " class="img-responsive"/>
                            ...
                            <div class="col-md-4 agile_ecommerce_tab_left">
                                ...
                                <h5>
                                    <a href="single.html">Headphones</a>
                                </h5>
                                <div class="simpleCart_shelfItem">
                                    <p>
                                        <span>$180</span>
                                        <i class="item_price">$150</i>
                                    </p>
                                    <form action="#" method="post">
                                        <input type="hidden" name="cmd" value="_cart"/>
                                        <input type="hidden" name="add" value="1"/>
                            ...
                            <div class="col-md-4 agile_ecommerce_tab_left">
                                ...
                                <h5>
                                    <a href="single.html">Audio Player</a>
                                </h5>
                                <div class="simpleCart_shelfItem">
                                    <p>
                                        <span>$220</span>
                                        <i class="item_price">$180</i>
                                    </p>
                                    <form action="#" method="post">
                                        <input type="hidden" name="cmd" value="_cart"/>
                                        <input type="hidden" name="add" value="1"/>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="video" aria-labelledby="video-tab">
                        <div class="agile_ecommerce_tabs">
                            <div class="col-md-4 agile_ecommerce_tab_left">
                                <div class="hs-wrapper">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/11.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/12.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/13.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/11.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/12.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/13.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/11.jpg" alt=" " class="img-responsive"/>
                            ...
                            <div class="col-md-4 agile_ecommerce_tab_left">
                                ...
                                <h5>
                                    <a href="single.html">Notebook</a>
                                </h5>
                                <div class="simpleCart_shelfItem">
                                    <p>
                                        <span>$290</span>
                                        <i class="item_price">$280</i>
                                    </p>
                                    <form action="#" method="post">
                                        <input type="hidden" name="cmd" value="_cart"/>
                                        <input type="hidden" name="add" value="1"/>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="tv" aria-labelledby="tv-tab">
                        <div class="agile_ecommerce_tabs">
                            <div class="col-md-4 agile_ecommerce_tab_left">
                                <div class="hs-wrapper">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/14.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/15.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/16.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/14.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/15.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/16.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/14.jpg" alt=" " class="img-responsive"/>
                            ...
                            <div class="col-md-4 agile_ecommerce_tab_left">
                                ...
                                <h5>
                                    <a href="single.html">LED Tv</a>
                                </h5>
                                <div class="simpleCart_shelfItem">
                                    <p>
                                        <span>$700</span>
                                        <i class="item_price">$680</i>
                                    </p>
                                    <form action="#" method="post">
                                        <input type="hidden" name="cmd" value="_cart"/>
                                        <input type="hidden" name="add" value="1"/>
                            ...
                            <div class="col-md-4 agile_ecommerce_tab_left">
                                ...
                                <h5>
                                    <a href="single.html">Washing Machine</a>
                                </h5>
                                <div class="simpleCart_shelfItem">
                                    <p>
                                        <span>$520</span>
                                        <i class="item_price">$510</i>
                                    </p>
                                    <form action="#" method="post">
                                        <input type="hidden" name="cmd" value="_cart"/>
                                        <input type="hidden" name="add" value="1"/>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="kitchen" aria-labelledby="kitchen-tab">
                        <div class="agile_ecommerce_tabs">
                            <div class="col-md-4 agile_ecommerce_tab_left">
                                <div class="hs-wrapper">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/17.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/18.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/19.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/17.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/18.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/19.jpg" alt=" " class="img-responsive"/>
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/17.jpg" alt=" " class="img-responsive"/>
                            ...
                            <div class="col-md-4 agile_ecommerce_tab_left">
                                ...
                                <h5>
                                    <a href="single.html">Coffee Maker</a>
                                </h5>
                                <div class="simpleCart_shelfItem">
                                    <p>
                                        <span>$250</span>
                                        <i class="item_price">$220</i>
                                    </p>
                                    <form action="#" method="post">
                                        <input type="hidden" name="cmd" value="_cart"/>
                                        <input type="hidden" name="add" value="1"/>
                    ...
                    <div class="col-md-7 modal_body_right">
                        ...
                        <div class="rating">
                            <div class="rating-left">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/star-.png" alt=" " class="img-responsive"/>
                            </div>
                            <div class="rating-left">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/star-.png" alt=" " class="img-responsive"/>
                            </div>
        ...
        <div class="w3agile_special_deals_grids">
            <div class="col-md-7 w3agile_special_deals_grid_left">
                <div class="w3agile_special_deals_grid_left_grid">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/21.jpg" alt=" " class="img-responsive"/>
                ...
                <div class="wmuSlider example1">
                    <div class="wmuSliderWrapper">
                        <article style="position: absolute; width: 100%; opacity: 0;">
                            <div class="banner-wrap">
                                <div class="w3agile_special_deals_grid_left_grid1">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/t1.png" alt=" " class="img-responsive"/>
                        ...
                        <article style="position: absolute; width: 100%; opacity: 0;">
                            <div class="banner-wrap">
                                <div class="w3agile_special_deals_grid_left_grid1">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/t2.png" alt=" " class="img-responsive"/>
                                    <p>Quis autem vel eum iure reprehenderit qui in ea voluptate
                                        velit esse quam nihil molestiae consequatur, vel illum qui dolorem
                                        eum fugiat quo voluptas nulla pariatur</p>
                                    <h4>Michael</h4>
                        ...
                        <article style="position: absolute; width: 100%; opacity: 0;">
                            <div class="banner-wrap">
                                <div class="w3agile_special_deals_grid_left_grid1">
                                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/t3.png" alt=" " class="img-responsive"/>
                                    <p>Quis autem vel eum iure reprehenderit qui in ea voluptate
                                        velit esse quam nihil molestiae consequatur, vel illum qui dolorem
                                        eum fugiat quo voluptas nulla pariatur</p>
                                    <h4>Rosy</h4>
            ...
            <div class="col-md-5 w3agile_special_deals_grid_right">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/20.jpg" alt=" " class="img-responsive"/>
            ...
            <div class="col-md-3 agileinfo_new_products_grid">
                <div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
                    <div class="hs-wrapper hs-wrapper1">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/25.jpg" alt=" " class="img-responsive"/>
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/23.jpg" alt=" " class="img-responsive"/>
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/24.jpg" alt=" " class="img-responsive"/>
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/22.jpg" alt=" " class="img-responsive"/>
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/26.jpg" alt=" " class="img-responsive"/>
            ...
            <div class="col-md-3 agileinfo_new_products_grid">
                <div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
                    <div class="hs-wrapper hs-wrapper1">
                        ...
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/35.jpg" alt=" " class="img-responsive"/>
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/36.jpg" alt=" " class="img-responsive"/>
                        <div class="w3_hs_bottom w3_hs_bottom_sub">
                            <ul>
                                <li>
            ...
            <div class="col-md-3 agileinfo_new_products_grid">
                <div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
                    <div class="hs-wrapper hs-wrapper1">
                        ...
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/39.jpg" alt=" " class="img-responsive"/>
...
<div class="top-brands">
    <div class="container">
        ...
        <div class="sliderfig">
            <ul id="flexiselDemo1">
                <li>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/tb1.jpg" alt=" " class="img-responsive"/>
                </li>
                <li>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/tb2.jpg" alt=" " class="img-responsive"/>
                </li>
                <li>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/tb3.jpg" alt=" " class="img-responsive"/>
                </li>
                <li>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/tb4.jpg" alt=" " class="img-responsive"/>
                </li>
                <li>
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/tb5.jpg" alt=" " class="img-responsive"/>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="footer-copy1">
            <div class="footer-copy-pos">
                <a href="#home1" class="scroll">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/arrow.png" alt=" " class="img-responsive"/>
                </a>
            </div>
        </div>
        <div class="container">
